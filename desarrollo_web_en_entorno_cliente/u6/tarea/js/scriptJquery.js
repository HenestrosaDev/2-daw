...
const setListeners = () => {
	...
	categories.on("change", function () {
		handleSelectChange(`?c=${$(this).val().replace(/ /g, "_")}`, [
			ingredients,
			glasses,
			alcoholics,
		]);
	...
	glasses.on("change", function () {
		handleSelectChange(`?g=${$(this).val().replace(/ /g, "_")}`, [
			categories,
			ingredients,
			alcoholics,
		]);
	...
	ingredients.on("change", function () {
		handleSelectChange(`?i=${$(this).val().replace(/ /g, "_")}`, [
			categories,
			glasses,
			alcoholics,
		]);
	...
	alcoholics.on("change", function () {
		handleSelectChange(`?a=${$(this).val().replace(/ /g, "_")}`, [
			categories,
			glasses,
			ingredients,
		]);
