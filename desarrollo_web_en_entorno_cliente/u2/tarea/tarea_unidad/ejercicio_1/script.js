...
const displayPopup = (width, height) => {
	...
	popup = window.open(
		this.href, // También se podría poner la ruta a un archivo HTML. e.g.: 'popup.html'
	...
	// Establecemos el intervalo pasando como parámetros la acción a ejecutar 
	// (movimiento de la ventana) y cada cuantos milisegundos queremos que se 
	// repita la acción (3000ms = 3s)
...
const movePopup = () => {
	...
	// Establecemos la posición de la ventana evitando que la mitad de ella salga 
	// de la pantalla
