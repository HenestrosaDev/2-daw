...
/**
 * Determina si una condición del feedback proporcionado al usuario se cumple o
 * no. En caso de que se cumpla, se tacha de la lista.
 *
 * @param {String} id: Identificador del elemento a controlar
 * @param {Boolean} shouldStrike: Determina si se tiene que añadir o no la clase
 * @param {String} classToHandle: Contiene la clase a añadir o eliminar. Por
 * defecto es 'text-decoration-line-through' ya que es el valor más recurrente.
 */
 ...
 *****************************************************************************
 * GRUPO 1: El primer carácter del nombre de usuario será una consonante en
 * mayúscula.
 *****************************************************************************
 * Regex: ^([^ -AEIOU[-ÿ])
 ...
 ******************************************************************************
 * GRUPO 2: El resto de caracteres en minúsculas. Letras, incluida la ñ, vocales
 * acentuadas, números y _
 ******************************************************************************
 * Regex: ([a-z0-9_à-úñ])
 ...
 ******************************************************************************
 - {4,14} el número de veces que se tiene que repetir el patrón, sin tener en
 ...
 ********************************** SUBMIT ***********************************
 *****************************************************************************
 * Al pulsar este botón se comprobará que todos los datos son requeridos y que
 * los datos son correctos según lo establecido en las expresiones regulares y
