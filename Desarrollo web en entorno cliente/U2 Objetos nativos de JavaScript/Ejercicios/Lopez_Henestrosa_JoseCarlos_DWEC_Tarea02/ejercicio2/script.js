...
const getYearsWhere6thDecIsMonday = () => {
	...
	que se encarga  de imprimir los resultados en el 
	HTML, lo cual  no interfiere con la  funcionalidad 
...
/* Esta función creará tantos elementos como 
años haya en el array */
const displayResults = (matchedYears) => {
	const results = document.getElementById("results");
	// Iteramos sobre los años almacenados
	for (let year of matchedYears) {
		/* Creamos un párrafo para cada año y lo adjuntamos 
		al elemento padre declarado arriba */
