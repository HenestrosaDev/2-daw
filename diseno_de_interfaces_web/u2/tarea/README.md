...
# TAREA Unidad 2: Accesibilidad y usabilidad en la web

## Índice

- [¿Qué te pedimos que hagas?](#qué-te-pedimos-que-hagas)
	- [Ejercicio 1: Navegación](#ejercicio-1-navegación)
		- [**a) Menú Principal**](#a-menú-principal)
		- [**b) Ubicación en la que nos encontramos**](#b-ubicación-en-la-que-nos-encontramos)
	- [Ejercicio 2: Desarrollo (usable y accesible)](#ejercicio-2-desarrollo-usable-y-accesible)
	- [Ejercicio 3: Análisis de la accesibilidad](#ejercicio-3-análisis-de-la-accesibilidad)
	- [Ejercicio 4: Análisis de usabilidad](#ejercicio-4-análisis-de-usabilidad)
- [Resultado](#resultado)
