<x-common.app page-title="Recuperar contraseña">
	<x-auth.auth-card title="Recuperar contraseña">
		<div class="mb-4 text-sm text-gray-600">
			¿Olvidaste la contraseña? No hay problema. Introduce tu dirección de email para que podamos
			enviarte un correo que contendrá un enlace en el que podrás restablecer la contraseña.
		</div>
