...
/* 
 * En vez de tener que acceder a cada método de un controlador, podemos
 * acceder a todos aquellos declarados en él. Cabe destacar que
 * el primer parámetro (en este caso, 'posts') es el nombre de la raíz
 * de la que derivan el resto de vistas del controlador.
 */
