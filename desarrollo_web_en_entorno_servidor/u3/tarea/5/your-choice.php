		...
		<header>
			<div class="p-3 pb-md-3 mx-auto text-center">
				...
				<p class="fs-5 text-muted mb-1">
					El precio de la masa mediana son 3.95€ (30 cm de diámetro) y 4.95€ la
					familiar (42 cm de diámetro).
				</p>
		...
		<main class="row g-5">
			...
			>
				...
				<ul class="list-group mb-3">
					<li
						id="checkout__dought"
						class="list-group-item d-flex justify-content-between lh-sm checkout__item"
					>
						<div>
							<h6
								id="dought__type"
			...
			<section id="ingredients" class="col-md-7 col-lg-8">
				<div class="card-group">
					<?php foreach ($ingredients as $ingredient) { ?>
						<div 
							id="<?= $ingredient["id"] ?>__card" 
							class="card" 
							title="Haz click para introducir los kgs" 
							aria-label="Haz click para introducir los kgs" 
							tabindex="0" 
							data-bs-toggle="modal" 
							data-bs-target="#buy__modal" 
							role="button"
						>
							<img 
								src="<?= $ingredient["image_path"] ?>" 
								class="card-img-top edible-image--sm p-4" 
								alt="<?= $ingredient["name_for_client"] ?>"
							>

							<div class="card-body">
								<h5 class="card-title">
									<span 
										id="<?= $ingredient["id"] ?>__name" 
										class="float-start"
									>
										<?= $ingredient["name_for_client"] ?>
									</span>
								</h5>
							</div>
						</div>
