![Captura de pantalla](https://github.com/HenestrosaDev/2-daw/blob/main/Desarrollo%20web%20en%20entorno%20servidor/U6%20Aplicaciones%20web%20din%C3%A1micas_%20PHP%20y%20JavaScript/Ejercicios/docs/screenshot.png)

# UNIDAD 6: Aplicaciones web dinámicas: PHP y JavaScript

## 1. Asincronía en las aplicaciones web
...
## 2. Node.js, npm y Laravel Breeze
...
## 3. Librerías y frameworks JavaScript
...
**Comentarios realizados por mí**: No quedaba claro en el enunciado del ejercicio que había que realizar una aplicación con React, ya que solo pone "Practica los principales [conceptos](https://reactjs.org/docs/hello-world.html) de React" y no tenía muchas más idea de qué hacer con eso. Debería haberle preguntado al profesor para haber evitado esta confusión. No obstante, he actualizado la tarea incluyendo una aplicación básica hecha con React, la cual está en el directorio `4` y es la mostrada en la captura de arriba.