...
<body class="bg-light">
	...
	<!-- Modal ingredientes -->
	<div class="modal fade" id="pizza__modal" tabindex="-1" aria-labelledby="pizza__title" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="pizza__title">Ingredientes</h5>
					...
					<div class="col">
						<div class="card">
							...
							<div class="card-body">
								...
								<a href="./your-choice.php" class="btn btn-primary btn__order float-end text-uppercase mt-4">Preparar</a>
							</div>
						</div>
					</div>
				</div>
