    ...
    <div id="main" class="main">
        ...
        <form id="form" action="#" method="post">
            <div class="form__columns">
                ...
                <input class="form__item" type="number" name="height" placeholder="Altura (en m)*" min="0.50" max="2.75" step="0.01" onkeyup="validateNumber(this)" pattern="^\d+(?:\.\d{1,2})?$" title="Entre 0.50 m y 2.50 m" required>
                <!-- Heaviest man on Earth: 635 kg. Source: https://en.wikipedia.org/wiki/List_of_heaviest_people -->
                <input class="form__item" type="number" name="weight" placeholder="Peso (en kg)*" min="1" max="640" step="0.01" onkeyup="validateNumber(this)" pattern="^\d+(?:\.\d{1,2})?$" title="Entre 1 kg y 300 kg" required>
