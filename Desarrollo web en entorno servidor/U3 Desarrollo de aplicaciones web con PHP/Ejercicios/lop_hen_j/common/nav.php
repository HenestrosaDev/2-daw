<nav class="navbar navbar-expand-md navbar-dark bg-dark">
	<div class="container-fluid">
		<a class="navbar-brand" href="<?= $relative . "/index.php" ?>">Unidad 3 | Ejercicios</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav me-auto mb-2 mb-md-0">
				...
				<li class="nav-item">
					<a class="nav-link <?= (!empty($active) && $active == 5) ? "active" : "" ?>" href="<?= $relative . "/5/admin.php" ?>">
						5
					</a>
				</li>
			</ul>
				...
				<?php if (!empty($show_cart)) { ?>
					<li class="nav-item dropdown">
						...
						<ul id="cart__list" class="dropdown-menu dropdown-menu-end dropdown-cart" aria-labelledby="cart">
							<li><a id="cart__confirm" class="dropdown-item text-center d-none">Confirmar pedido</a></li>
