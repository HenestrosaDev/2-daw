	...
	<div class="container pt-3" style="max-width: 960px;">
		...
		<main>
			<div class="text-center">
				...
				<p>Credenciales para los ejercicios 1, 4 y 5: <strong>admin</strong>: 1234 / <strong>user</strong>: 1234</p>
				<p>Si has sido redireccionado aquí al cerrar sesión, vuelve a acceder a la página del ejercicio que desees e inicia sesión.</p>
			</div>
		</main>
